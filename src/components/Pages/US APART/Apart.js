        ...
        <div className='px-10 w-full h-[100vh] text-center flex justify-center items-center'>
            <div>
                <div className='text-5xl font-bold  '>
                    <h1 className='text-2xl text-[#7B7B7B] font-medium mb-6 lett space-x-11 '>WHAT SETS US APART</h1>
                    <div data-aos="zoom-in-up" className='text-[#101010]'>
                        ...
                        <div className='mb-4'>clients. We rigorously research, ideate,
                            <span className='text-[#2BFD86]'> design <button className='text-green-500 bg-black p-1 text-3xl rounded-full'><AiOutlineArrowRight /></button> </span>
                        </div>
                        <div className='mb-4'> and
                            <span className='text-[#2BFD86]'> iterate <button className='text-green-500 bg-black p-1 text-3xl rounded-full'><AiOutlineArrowRight /></button> </span>
