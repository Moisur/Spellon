    ...
    return (
        <div className='w-full h-[100%] md:h-[91vh] relative mt-5 '>
            <div className='ml-[184px]' data-aos="fade-right">
                <h1 className='text-9xl  font-bold'>Experience + <span className='text-[#7B7B7B]'>Creativ</span></h1>
                <p className='text-2xl text-[#7B7B7B] mt-10'>We're an innovative design agency building high-end products <br />and experiences that grow your business exponentially</p>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='absolute bottom-0 right-0'>
                        <div className='flex items-center gap-4 '>
                            <h1 className=' text-[#7B7B7B] text-lg'>RECENT PROJECT</h1>
