...
const Banner = () => {
    return (
        <div className='w-full h-100 md:h-[91vh] relative'>
            ...
            <div className='mt-16 flex justify-around items-center'>
                <div>
                    <button className=' flex justify-center items-center gap-3 text-2xl font-medium px-8 py-3 bg-slate-700 uppercase rounded-sm'>view our works <span><AiOutlineArrowRight /></span> </button>
                </div>
            ...
            <div className='hidden md:block'>
                <div className='flex justify-between'>
                    <div></div>
                    <div className='absolute bottom-0 right-[-32px]'>
